  ...
  <div className="mx-auto lg:mx-0 mt-8 lg:mt-0 w-64 sm:w-72 rounded-lg bg-white border border-solid border-gray-200">
    ...
    <div>
      <div className="py-5 border-b border-solid border-gray-200">
        <p className="text-center text-4xl font-bold text-blue-600">{wpm} WPM</p>
      ...
      <div className="bg-gray-100 result-list">
        ...
        <span>
          (<span className="text-blue-600">{correctKeystroke}</span> |{' '}
          <span className="text-red-400">{wrongKeystroke}</span>){' '}
          <span>{correctKeystroke + wrongKeystroke}</span>
        </span>
      </div>
      ...
      <div className="bg-gray-100 result-list">
        ...
        <span className="font-bold text-blue-600">{correctWords}</span>
      </div>
      <div className="result-list">
